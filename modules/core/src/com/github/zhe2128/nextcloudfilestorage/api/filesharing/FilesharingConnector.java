 ...
 */
package com.github.zhe2128.nextcloudfilestorage.api.filesharing;

import org.aarboard.nextcloud.api.ServerConfig;
import org.aarboard.nextcloud.api.exception.MoreThanOneShareFoundException;
import org.aarboard.nextcloud.api.filesharing.*;
...
public class FilesharingConnector {
    ...
    public CompletableFuture<SharesXMLAnswer> getShareInfoAsync(int shareId) {
        return connectorCommon.executeGet(SHARES_PART + "/" + shareId, null, XMLAnswerParser.getInstance(SharesXMLAnswer.class));
    }
